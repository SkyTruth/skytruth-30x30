...
export interface ApiDataInfoDataInfo extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    data_sources: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiDataSourceDataSource extends Struct.CollectionTypeSchema {
...
export interface ApiDataToolLanguageDataToolLanguage
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    data_tool: Schema.Attribute.Relation<
      'manyToOne',
...
export interface ApiDataToolDataTool extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    data_tool_ecosystems: Schema.Attribute.Relation<
      'oneToMany',
      'api::data-tool-ecosystem.data-tool-ecosystem'
    >;
    data_tool_resource_types: Schema.Attribute.Relation<
      'oneToMany',
      'api::data-tool-resource-type.data-tool-resource-type'
    >;
...
export interface ApiFeatureFlagFeatureFlag extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    active_on: Schema.Attribute.DateTime;
...
export interface ApiFishingProtectionLevelStatFishingProtectionLevelStat
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    fishing_protection_level: Schema.Attribute.Relation<
      'oneToOne',
    ...
    pct: Schema.Attribute.Float;
    publishedAt: Schema.Attribute.DateTime;
    total_area: Schema.Attribute.BigInteger;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiHabitatStatHabitatStat extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    environment: Schema.Attribute.Relation<
      'oneToOne',
      'api::environment.environment'
    >;
    habitat: Schema.Attribute.Relation<'oneToOne', 'api::habitat.habitat'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    protected_area: Schema.Attribute.Decimal &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
...
export interface ApiLayerLayer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dataset: Schema.Attribute.Relation<'oneToOne', 'api::dataset.dataset'>;
    ...
    environment: Schema.Attribute.Relation<
      ...
      'api::environment.environment'
    >;
    interaction_config: Schema.Attribute.JSON &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
      }>;
    legend_config: Schema.Attribute.Component<'legend.legend', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    metadata: Schema.Attribute.Component<'documentation.metadata', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    params_config: Schema.Attribute.JSON &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
...
export interface ApiLocationLocation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    fishing_protection_level_stats: Schema.Attribute.Relation<
      'oneToMany',
      'api::fishing-protection-level-stat.fishing-protection-level-stat'
    >;
    groups: Schema.Attribute.Relation<'manyToMany', 'api::location.location'>;
    has_shared_marine_area: Schema.Attribute.Boolean;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    marine_bounds: Schema.Attribute.JSON;
    marine_target: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          max: 100;
          min: 0;
        ...
        number
      >;
    marine_target_year: Schema.Attribute.Integer;
    members: Schema.Attribute.Relation<'manyToMany', 'api::location.location'>;
    mpaa_protection_level_stats: Schema.Attribute.Relation<
      'oneToOne',
    ...
    name_pt: Schema.Attribute.String & Schema.Attribute.Required;
    pas: Schema.Attribute.Relation<'oneToMany', 'api::pa.pa'>;
    protection_coverage_stats: Schema.Attribute.Relation<
      'oneToMany',
      'api::protection-coverage-stat.protection-coverage-stat'
    >;
    publishedAt: Schema.Attribute.DateTime;
    terrestrial_bounds: Schema.Attribute.JSON;
    total_marine_area: Schema.Attribute.BigInteger & Schema.Attribute.Required;
    total_terrestrial_area: Schema.Attribute.BigInteger &
      Schema.Attribute.Required;
...
export interface ApiMpaaProtectionLevelStatMpaaProtectionLevelStat
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    location: Schema.Attribute.Relation<'oneToOne', 'api::location.location'>;
    mpaa_protection_level: Schema.Attribute.Relation<
      'oneToOne',
...
export interface ApiPaPa extends Struct.CollectionTypeSchema {
  collectionName: 'pas';
  info: {
    description: '';
    displayName: 'PA';
  ...
  attributes: {
    area: Schema.Attribute.Decimal &
      ...
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    bbox: Schema.Attribute.JSON & Schema.Attribute.Required;
    children: Schema.Attribute.Relation<'oneToMany', 'api::pa.pa'>;
    coverage: Schema.Attribute.Decimal &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
    ...
    environment: Schema.Attribute.Relation<
      ...
      'api::environment.environment'
    >;
    iucn_category: Schema.Attribute.Relation<
      'oneToOne',
      'api::mpa-iucn-category.mpa-iucn-category'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::pa.pa'> &
      Schema.Attribute.Private;
    location: Schema.Attribute.Relation<'manyToOne', 'api::location.location'>;
    mpaa_establishment_stage: Schema.Attribute.Relation<
      'oneToOne',
      'api::mpaa-establishment-stage.mpaa-establishment-stage'
    >;
    mpaa_protection_level: Schema.Attribute.Relation<
    ...
    >;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    parent: Schema.Attribute.Relation<'oneToOne', 'api::pa.pa'>;
    protection_status: Schema.Attribute.Relation<
      'oneToOne',
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    wdpa_p_id: Schema.Attribute.String;
    wdpaid: Schema.Attribute.BigInteger;
    year: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    zone_id: Schema.Attribute.BigInteger;
  };
}
...
export interface ApiProtectionCoverageStatProtectionCoverageStat
  ...
  attributes: {
    ...
    environment: Schema.Attribute.Relation<
      ...
      'api::environment.environment'
    >;
    global_contribution: Schema.Attribute.Decimal;
    is_last_year: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::protection-coverage-stat.protection-coverage-stat'
    > &
      Schema.Attribute.Private;
    location: Schema.Attribute.Relation<'manyToOne', 'api::location.location'>;
    oecms: Schema.Attribute.Decimal;
    pas: Schema.Attribute.Decimal;
    protected_area: Schema.Attribute.Decimal &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        ...
        number
      >;
    protected_areas_count: Schema.Attribute.Integer & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    total_area: Schema.Attribute.BigInteger;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
