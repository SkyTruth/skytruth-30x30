    ...
    gdf = gpd.GeoDataFrame(
        {
            ...
            "establishment_stage": ["actively managed", "implemented", "designated", "proposed/committed", "unknown"],
        ...
        geometry=gpd.GeoSeries.from_wkt(["POINT (0 0)", "POINT (1 1)", "POINT (2 2)", "POINT (3 3)", "POINT (4 4)"]),
        crs="EPSG:4326",
    )
